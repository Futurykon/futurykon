          ...
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <div className="flex gap-4">
                <Button variant="outline" size="lg" className="text-lg px-8 py-4 rounded-xl border-white/50 bg-transparent text-white hover:bg-white hover:text-magenta backdrop-blur-sm transition-all duration-300" asChild>
      ...
      <section className="py-20 aurora-gradient-linear text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="text-lg px-8 py-4 rounded-xl border-white/50 bg-transparent text-white hover:bg-white hover:text-magenta transition-all duration-300">
              Przeglądaj rynki
            </Button>
          </div>
        </div>
